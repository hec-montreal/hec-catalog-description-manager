...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:fluid.messageLocator(messageBundle)(["table_first_entrie"]),sLast:fluid.messageLocator(messageBundle)(["table_last_entrie"]),sNext:fluid.messageLocator(messageBundle)(["table_next_entrie"]),sPrevious:fluid.messageLocator(messageBundle)(["table_previous_entrie"])},sEmptyTable:fluid.messageLocator(messageBundle)(["table_data_empty"]),sInfo:fluid.messageLocator(messageBundle)(["table_info_entries"]),sInfoEmpty:fluid.messageLocator(messageBundle)(["table_info_empty"]),sInfoFiltered:fluid.messageLocator(messageBundle)(["table_info_filter"]),sInfoPostFix:"",sInfoThousands:",",sLengthMenu:fluid.messageLocator(messageBundle)(["table_filter_entries"]),sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:fluid.messageLocator(messageBundle)(["table_search"]),sUrl:"",sZeroRecords:fluid.messageLocator(messageBundle)(["table_no_matching_record"])},
